...
HEIGHT = 1078   # Must be multiple of 14 for DA3 (77 x 14)
WIDTH  = 1918   # Must be multiple of 14 for DA3 (137 x 14)
...
# [WARN] DO NOT use torch.jit.optimize_for_inference()
...
- HD 1080p -> `1918 x 1078` (137x14, 77x14)
- UHD 2160p -> `3836 x 2156` (274x14, 154x14)
...
# [WARN] Set modelFile LAST - loading the .pt blocks the Python thread
import nuke
...
```
Read (footage)
  +--> Reformat (to model resolution, e.g. 1918x1078, type="to box", resize=distort)
...
Model resolution: 1918 x 1078 (multiples of 14)
Channels In: `rgba.red,rgba.green,rgba.blue`
Channels Out: `depth.Z`
...
**Article I - General Purpose:** [OK] All patterns parameterized (no hardcoded paths)
**Article III - Progressive Disclosure:** [OK] ~400 lines
**Article IV - Independent Testing:** [OK] Validated in Nuke 17.0v1-Beta.5 with DA3
**Article V - Official Patterns:** [OK] Based on Foundry official docs (Nuke 17.0 CFC Reference)
**Article VI - Context Efficiency:** [OK] Single file, reference links for deep docs
