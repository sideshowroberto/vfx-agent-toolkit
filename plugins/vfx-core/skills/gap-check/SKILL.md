...
**[OK] Confident** - You have seen this documented or used it correctly in verified contexts. State your source if possible.
...
**[FAIL] Guessing** - You are inferring from related knowledge or pattern-matching. You could be wrong. State the assumption explicitly.

Be ruthless. The most common failure mode is treating ~ and [FAIL] items as [OK]. If you haven't verified it recently or it's version-sensitive, it's not [OK].

## Step 3 - Classify gaps by who can fill them

After the audit, sort the ~ and [FAIL] items into three buckets:
...
```
VALIDATED KNOWLEDGE
[OK] [item] - [source or confidence reason]
[OK] [item] - [source or confidence reason]

GAPS FILLED BY RESEARCH
[OK] [item] - [what research found]
...
STILL UNKNOWN
[FAIL] [item] - [why it couldn't be resolved and what the risk is if assumed]
```
