...
| Timing | Shot sequencing or time structure. | `0-2s steady; 2-4s door opens, flame bends; 4-5s smoke curls toward hallway` |
...
| A2V | Audio drives pacing, rhythm, and emotion. | Ignoring audio cues and writing motion that fights the beat. | Sync visible actions and camera moves to audio hits; state what happens on each cue. |
